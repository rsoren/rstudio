...
public class EnhancedSplitPanel extends NotifyingSplitLayoutPanel
      implements SplitterResizedHandler
{
   ...
   @Inject
   public EnhancedSplitPanel(EventBus events,
                         Session session,
                         UserPrefs uiPrefs)
   {
      super(
   ...
   public void initialize(ArrayList<Widget> leftSource, Widget center, Widget right)
   {
